...
# First, data is loaded from the 'AMD.csv' file and given the name 'amd_df'.

amd_df <- read.csv("AMD.csv")

# We then convert the 'Date' column in the 'amd_df' data frame to date format and store this in a new column called 'date'. 

amd_df$date <- as.Date(amd_df$Date)

# Additionally, we convert the 'Adj.Close' column in the 'amd_df' data frame to numeric format and store this in a new column called 'close'.

amd_df$close <- as.numeric(amd_df$Adj.Close)

# Finally, we modify the 'amd_df' data frame such that it only includes the 'date' and 'close' columns. 
...
# We generate a plot of the closing prices of the AMD stock, with respect to time.
